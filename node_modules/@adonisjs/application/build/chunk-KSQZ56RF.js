...
var RcFileParser = class {
  ...
  #getAssembler() {
    ...
    return new ObjectBuilder({}).add("runner", runner).add("onBuildStarting", this.#rcFile.unstable_assembler.onBuildStarting).add("onBuildCompleted", this.#rcFile.unstable_assembler.onBuildCompleted).add("onDevServerStarted", this.#rcFile.unstable_assembler.onDevServerStarted).toObject();
  }
  /**
...
//# sourceMappingURL=chunk-KSQZ56RF.js.map